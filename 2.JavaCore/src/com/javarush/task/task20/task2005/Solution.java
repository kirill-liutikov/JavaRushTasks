...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = new File("C:\\Users\\kirill\\IdeaProjects\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2005\\test.txt");
            ...
            somePerson.getAssets().stream().forEach(System.out::println);
            inputStream.close();
